...
<template>
  <nuxt-link
    ...
    :class="{
      'index-services-card_centered': textCenter,
      'index-services-card_no-mobile-icon': noMobileIcon
    }"
    :to="to"
  >
